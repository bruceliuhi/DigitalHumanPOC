    ...
    <div className="flex justify-center items-center w-screen h-screen bg-gradient-to-br from-gray-50 via-slate-50 to-blue-50/30 overflow-hidden relative">
      ...
      >
        ...
        <div className="absolute inset-0 z-50 pointer-events-none">
          {/* 标题和副标题 */}
          <div className="absolute top-20 left-1/2 -translate-x-1/2 text-center pointer-events-auto">
            <h1
          ...
          {/* 服务卡片 */}
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 w-[480px] flex flex-col gap-2.5 pointer-events-auto">
            <button
